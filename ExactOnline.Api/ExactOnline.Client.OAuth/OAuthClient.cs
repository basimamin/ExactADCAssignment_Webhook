...
namespace ExactOnline.Client.OAuth
{
	public class OAuthClient : UserAgentClient
	{
        ...
        public void Authorize(ref IAuthorizationState authorization, string refreshToken, string AuthorizationUri)
		{
			...
			{
                //*** Change that code in order to be compatible with Web Application
                ...
                ProcessUserAuthorization(new Uri(AuthorizationUri) , authorization);
