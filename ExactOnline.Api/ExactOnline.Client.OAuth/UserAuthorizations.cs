...
namespace ExactOnline.Client.OAuth
{
	public static class UserAuthorizations
	{
        ...
        public static void Authorize(UserAuthorization authorization, string website, string clientId, string clientSecret, Uri redirectUri, string AuthorizationUri)
		{
            ...
            oAuthClient.Authorize(ref authorizationState, authorization.RefreshToken, AuthorizationUri);
